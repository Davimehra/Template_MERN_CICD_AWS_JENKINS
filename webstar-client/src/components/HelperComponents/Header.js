...
import { removeFromAuth, addToAuth } from "../../redux/slices/authSlice";
...
export default function Header() {
    ...
    const SignOutHandler = () => {
        dispatch(removeFromAuth())
    }
    return (
        <React.Fragment>
            <div className={HeaderCss.MainContainer}>
                <div className={HeaderCss.SiteNameContainer} ><p onClick={SiteNameHandler}>Site Name</p></div>
